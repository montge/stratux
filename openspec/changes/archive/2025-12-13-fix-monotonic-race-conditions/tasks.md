...
- [x] 2.1 Update gen_gdl90.go to use getters
- [x] 2.2 Update gps.go to use getters
- [x] 2.3 Update traffic.go to use getters
- [x] 2.4 Update messagequeue.go to use getters
- [x] 2.5 Update trace.go to use getters

## 3. Update Test Code (use getters instead of direct access)
- [x] 3.1 Update monotonic_test.go (added getter tests, updated concurrent test)
